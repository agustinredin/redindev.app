...
const Hero = () => {
    ...
    return (
        <chakra.Container m={'auto'} minH={'100vh'} >
                <chakra.Flex direction="column">
                    ...
                    <chakra.Box mt={{ md: 10 }} ml={{base: '0px', md: '3rem'}}>
                        ...
                        <chakra.Box fontFamily={"'Geist Sans', sans-serif"} fontSize={{ base: '65', md: '75', lg: '85' }} className="portfolio-orange-hex"  height={{sm:'4.5em', md: '4em', lg:'fit-content'}}>
                            <Typewriter delay={5000} messages={messages} wrapperTag={'h2'}/>
                        </chakra.Box>

                    </chakra.Box>
                    
                    <chakra.Flex justifyContent={'center'} w={'100%'} px={{base: '2rem', md: '4rem'}} h={{base: '8em'}} className={'button-custom'} mt={'0.5rem'} alignItems={'center'} position="relative">
                        <chakra.Text className='highlight' fontSize={{base: '30', 'md': '40', lg:'50'}}> Get in touch </chakra.Text>
